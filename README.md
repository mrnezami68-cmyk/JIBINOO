...
- **حساب‌های بانکی (فاز ۱۵)**: چند حساب/کیف پول با موجودی جدا (مثلاً «سامان — خرج خانه»، «سپه — پس‌انداز»)؛ نقد کل = مجموع حساب‌ها؛ انتخاب حساب مبدأ/مقصد در همه پرداخت‌ها و واریزها؛ **انتقال بین حساب‌ها** (ثبت در دفتر، بدون اثر بر درآمد/هزینه/نقد کل)؛ حذفِ پول‌دار بلاک، حذفِ تاریخچه‌دار آرشیو
